...
8. Extract the Latin word entries from the Wiktionary dump ("raw-wiktextract-data.jsonl" will be downloaded from from https://kaikki.org/dictionary/rawdata.html): run {latin-leven repo}\tools\parse_wiktextract.py.
